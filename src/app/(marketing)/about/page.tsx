...
export const metadata: Metadata = pageMetadata({
  title: 'About Annah',
  description:
    'Annah is an AI mortgage guide built specifically for Scotland — explaining Home Reports, LBTT, offers over and the schemes available to Scottish buyers in plain English.',
  path: '/about',
});
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="Buying a home in Scotland works differently. Annah explains the parts that trip people up — and gives you instant numbers to plan around."
      />
      <Section tight>
        <Prose>
          <p>
            Most mortgage tools are written for the English market. Scotland has its own legal
            process, its own purchase tax, and its own home-buying schemes. Annah was built to close
            that gap with guidance that is genuinely Scotland-first.
          </p>

          <h2>What Annah does</h2>
          <p>
            Annah combines a conversational assistant with a set of Scotland-aware calculators. You
          ...
          <p>
            Annah gives <strong>general information and indicative calculations only</strong>. It is
